...
(function() {
  ...
  CopyCopter = (function() {
    ...
    create = function(options) {
      var apiKey, callbacks, createTranslation, drain, exports, getUrl, hasTranslation, host, interpolate, isLoaded, lookup, onTranslationsLoaded, password, postUrl, translate, translations, username;
      ...
      if (!(username = options.username)) {
        throw 'please provide the username';
      }
      if (!(password = options.password)) {
        throw 'please provide the password';
      }
