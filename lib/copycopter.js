...
(function() {
  ...
  CopyCopter = (function() {
    ...
    create = function(options) {
      var apiKey, callbacks, drain, exports, host, interpolate, isLoaded, load, lookup, setOptions, translations, url;
      ...
      exports = {};
      exports.t = exports.translate = function(key, options) {
        var defaultValue;
      ...
      exports.onLoaded = function(callback) {
        if (isLoaded) {
          return callback();
        } else {
